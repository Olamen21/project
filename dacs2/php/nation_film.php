...
<?php 
 if(isset($_GET['id_user'])){
  ...
  if(isset($_GET['maquocgia'])){
    $maquocgia = $_GET['maquocgia'];
    $sql = "SELECT * FROM quocgia WHERE maquocgia='$maquocgia'";
...
<section id="header">
  		...
  		<div class="container">
    		...
    		<div class="collapse navbar-collapse" id="navbarSupportedContent">
                  ...
                  <?php 
					...
					<li class="nav-item dropdown">
          				<a class="nav-link dropdown-toggle active" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Quốc gia</a>
          				<ul class="dropdown-menu drop_1" aria-labelledby="navbarDropdown">
                  <?php 
  ...
  <section class="all_film" id="all_film">
        ...
        <h1 class="heading"><?php echo $tenquocgia; ?></h1>
        <hr>
        ...
        <div class="row">
        <?php 
                 $sql = "SELECT * FROM phim WHERE maquocgia='$maquocgia'";
                 $qr = mysqli_query($conn, $sql);
