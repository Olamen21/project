...
if(isset($_POST['name'])) {
    ...
    if(isset($_FILES['anh'])) {
        ...
        $sql = "INSERT INTO dienvien(avatar,ten) VALUES
            ('$ten_anh','$name')";
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <?php foreach($dienvien as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><img src="../img/<?php echo $value['avatar'] ?>" width="100" ></td>
                                        <td><?php echo $value['ten'] ?></td>
                                        
                                        
                                        <td><a onclick="return confirm('Bạn có muốn xóa diễn viên này không?');" class="btn btn-sm btn-primary" href="xoa_dienvien.php?id=<?php echo $value['id'] ?>">Xóa</a></td>
                                        <td><a class="btn btn-sm btn-primary" href="sua_dienvien.php?id=<?php echo $value['id'] ?>">Sửa</a></td>
                                    </tr>
                                    <?php } ?>
