...
include 'connect.php';
$id = $_GET['id'];
$sql = mysqli_query($conn, "select * from movie as m, phim as p where m.id_phim = p.maphim and id=$id");
$movie = mysqli_fetch_assoc($sql);
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                <!-- Movie -->
                    ...
                    <div class="bg-secondary rounded h-100 p-4">
                            <form action="update_movie.php" method="POST" role="form" enctype="multipart/form-data">
                                <input type="hidden" name="id" value="<?php echo $id ?>">
                                <select name="id_phim" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
                                <option value="<?php echo $movie['id_phim'] ?>"><?php echo $movie['tenphim'] ?></option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="text" name="tap" value="<?php echo $movie['tập_phim'] ?>">
                                </div>
                                
                                <div class="mb-3">
                                    <label class="form-label">Thời gian chiếu</label>
                                    <input type="text" class="form-control" id="text" name="time" value="<?php echo $movie['thoigian'] ?>">
                                </div>
