...
<?php 
    ...
    // $id = $_GET['id'];
    // $sql_history =  "SELECT * FROM lich_su_dat_banh WHERE id=$id";
    // $query_history = mysqli_query($conn,$sql_history);
    
    $date = $_GET['date'];
$sql = "SELECT * FROM history WHERE date='$date' AND userid=$id_user;";
$query = mysqli_query($conn, $sql);
$row = mysqli_fetch_array($query);

$sql_history = "SELECT * FROM lich_su_dat_banh WHERE date='$date' AND userid=$id_user;";
$query_history = mysqli_query($conn, $sql_history);
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-0 sticky-top">
        ...
        <div class="collapse navbar-collapse p-3" id="navbarCollapse">
            ...
            <div class="navbar-nav ms-auto mx-lg-auto  py-0">
                ...
                <a href="./contact_user.php?id_user=<?php echo $id_user; ?>" class="nav-item nav-link active">Liên hệ</a>
            </div>
    ...
    <div class="container-fluid bg-dark bg-img p-5 mb-5">
        <div class="row">
            <div class="col-12 text-center">
                <h1 class="display-4 text-uppercase text-white">Chi tiết lịch sử đơn hàng</h1>
                <a href="./user.php">Trang chủ</a>
                <i class="far fa-square text-primary px-2"></i>
                <a href="#">Chi tiết lịch sử đơn hàng</a>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
    ...
    <div class="container-fluid about py-5">
        <div class="container">
            <div class="row gx-5">
                <div class="col-lg-4 col-md-12 mb-lg-0 mb-4 px-lg-3">
                ...
                <div class="col-lg-8 pb-5">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="dataTable" width="80%" cellspacing="0">
                            ...
                            <?php 
                                $i = 0;
                                while($row_history = mysqli_fetch_assoc($query_history)){
                                $i++;
                            ?>
                            <tr> 
                                <td><?php echo $i ?></td>
                                <td><?php echo $row_history['cakename']?></td>
                                <td><?php echo $row_history['quantity']?></td>
                                <td><?php echo $row_history['price']?> VNĐ</td>
                                <td><?php echo $row_history['total']?> VNĐ</td>
                            </tr>
                            <?php }?>
                            <tr> 
                                <td colspan="4"> Tổng tiền</td>
                                <?php 
                                    $sqlTotal ="SELECT SUM(total) AS tong_gia_tri FROM lich_su_dat_banh WHERE date='$date' AND userid=$id_user;;";
                                    $qrTotal = mysqli_query($conn, $sqlTotal);
                                    $rowTotal = mysqli_fetch_array($qrTotal);
                                ?>
                                <td><?php echo $rowTotal['tong_gia_tri']?> VNĐ</td>
                            </tr>
                        </table>
                    </div>
                </div>
                    ...
                    <div class="row gx-5">
                        ...
                        <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                            ...
                            <div class="d-flex flex-column justify-content-start">
                                ...
                                <a class="text-secondary" href="./contact.php"><i class="bi bi-arrow-right text-primary me-2"></i>Liên hệ</a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
    ...
    <div class="container-fluid text-secondary py-4" style="background: #111111;">
        <div class="container text-center">
            <p class="mb-0">Thank you very much !!!</p>
        </div>
    </div>
    <!-- Footer End -->
