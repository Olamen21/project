...
<head>
    ...
    <!-- Title Page-->
    <title>Quarn lý người dùng</title>
    <!-- Fontfaces CSS-->
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div style="background-color: pink; height: 40px;">
                            <label class="text-dark" style="margin:7px 0 0 7px;">DANH SÁCH NGƯỜI DÙNG</label>
                        </div><br>
                                    ...
                                    if($count <=0 ){
                                         echo <<< alert
                                            <div class="alert alert-danger d-flex align-items-center" role="alert">
                                                <strong class="me-3">Không tìm thấy tên người dùng. Vui lòng kiểm tra lại!!!</strong>
