<?php
    ...
    if (isset($_POST['sbm'])) {
        ...
        $sql = "INSERT INTO cake (ava,cakename,caketype,price,quantity,decription	) 
                VALUES ('$image','$tenbanh',$typecake,$gia,$soluong,'$mota')"; 
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div style="background-color: pink; height: 40px;">
                            <label class="text-dark" style="margin:7px 0 0 7px;">THÊM MỚI BÁNH</label>
                        </div><br>
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-sm">
                                    <label class="text-dark font-weight-bold">Tên bánh</label><br>
                                    <input name="tenbanh" type="text" class="form-control" required>
                                </div>
                                <div class="col-sm">
                            ...
                            <div class="row">
                                ...
                                <button name="sbm" class="btn btn-outline-dark" type="submit">Thêm mới</button>
