<?php
    ...
    if (isset($_POST['sbm'])) {
        ...
        $sql = "INSERT INTO users (username,address,phone,email,pass,usertype) 
                VALUES ('$tenuser','$diachi','$phone','$email','$pass',$typeuser)"; 
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <input name="tenuser" type="text" class="form-control" required>
                                </div>
                                <div class="col-sm">
