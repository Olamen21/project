...
if(isset($_POST['search'])) {
    $s = $_POST['search'];
    $sql = "select * from contact where (uname like '%$s%') or (email like '%$s%') or (phone like '%$s%') or (content like '%$s%') ";
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <h2 class="title-1 m-b-25">Liên hệ</h2>
                                    ...
                                    <?php  if($count <= 0 ){
                                        ...
                                        <tbody>
                                            ...
                                            <td><?php echo $value['uname'] ?></td>
                                                ...
                                                <td>
                                                    <a  class="btn btn-info text-dark" href="formsuacontact.php?id= <?php echo $value['id'] ?>">Sửa</a>
                                                   
                                                </td>
                                                <td> <a onclick="return confirm('Bạn có muốn xóa không?');" href="xoacontact.php?id= <?php echo $value['id'] ?>"  class="btn btn-danger text-dark" >Xóa</a></th></td>
                                            </tr>
