...
include 'db.php';
$id = $_GET['id'];
$sql = mysqli_query($conn,"select * from lich_su_dat_banh where id = $id");
...
if(isset($_POST['id_cake'])) {
    ...
    $sql = "UPDATE history SET userid = '$userid', cakeid = '$cakeid', quantity = '$quantity' WHERE id = $id ";
                                ...
                                <div class="card">
                                   ...
                                   <div class="card-body card-block">
                                        ...
                                        <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <select name="id_cake" id="select" class="form-control">
                                                        <option value="<?php echo $row['id_cake'] ?>"><?php echo $row['cakename'] ?></option>
                                       ...
                                       <div class="has-warning form-group">
                                           ...
                                           <input type="number" id="inputWarning2i" class="form-control-warning form-control" name="quantity" value="<?php echo $row['quantity'] ?>">
                                       </div>
