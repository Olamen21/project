...
session_start();
include 'connect.php';
$phim = mysqli_query($conn, "select * from phim as p , theloai as t, quocgia as q, phanloai as pl where p.matheloai = t.matheloai and p.maquocgia = q.maquocgia and p.maloai = pl.maphanloai;");
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <?php foreach($phim as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><video width="200px" controls><source src="../trailer/<?php echo $value['trailer'] ?>"></video></td>
                                        <td><a onclick="return confirm('Bạn có muốn xóa phim này không?');" class="btn btn-sm btn-primary" href="xoa.php?id=<?php echo $value['maphim'] ?>">Xóa</a></td>
                                        <td><a class="btn btn-sm btn-primary" href="sua.php?id=<?php echo $value['maphim'] ?>">Sửa</a></td>
                                    </tr>
                                    <?php } ?>
