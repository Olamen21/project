...
if(isset($_POST['id_phim'])) {
    ...
    if(isset($_FILES['video'])) {
        ...
        move_uploaded_file($video['tmp_name'],"../video/".$video_name);

        $sql = "INSERT INTO movie(id_phim,tập_phim,thoigian,link) VALUES
            ('$id_phim','$tap','$time','$video_name')";
...
$movie = mysqli_query($conn, "select * from movie as m, phim as p where m.id_phim = p.maphim");
?>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="./movie.php" class="nav-link nav-item active"><i class="fa fa-table me-2"></i>Movie</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
                            ...
                            <tbody>
                                <?php foreach($movie as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo $value['tập_phim'] ?></td>
                                        <td><?php echo $value['thoigian'] ?></td>
                                        <td><video width="200px" controls><source src="../video/<?php echo $value['link']?>"></video></td>
                                        <td><a onclick="return confirm('Bạn có muốn xóa tập này không?');" class="btn btn-sm btn-primary" href="xoa_movie.php?id=<?php echo $value['id'] ?>">Xóa</a></td>
                                        <td><a class="btn btn-sm btn-primary" href="sua_movie.php?id=<?php echo $value['id'] ?>">Sửa</a></td>
                                    </tr>
                                <?php } ?>
                ...
                <!-- Movie -->
                    ...
                    <div class="bg-secondary rounded h-100 p-4">
                            <form action="" method="POST" role="form" enctype="multipart/form-data">
                                <select name="id_phim" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="text" name="tap">
                                </div>
                                
                                <div class="mb-3">
                                    <label class="form-label">Thời gian chiếu</label>
                                    <input type="text" class="form-control" id="text" name="time">
                                </div>
                              
                                <div class="mb-3">
                                    <label class="form-label">Video</label>
                                    <input type="file" class="form-control" id="text" name="video">
                                </div>
