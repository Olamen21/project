...
<section id="header">
    		...
    		<div class="collapse navbar-collapse" id="navbarSupportedContent">
      			<ul class="navbar-nav mb-0">
        			...
        			<li class="nav-item dropdown">
          				<a class="nav-link dropdown-toggle active" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Thể loại</a>
  ...
  <section class="all_film" id="all_film">
        ...
        <h1 class="heading"><?php echo $tentheloai; ?></h1>
        <hr>
        ...
        <div class="row ">
        <?php 
                 $sql = "SELECT * FROM phim WHERE matheloai='$matheloai'";
                 $qr = mysqli_query($conn, $sql);
